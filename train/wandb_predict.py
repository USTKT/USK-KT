...
from datasets import init_test_datasets
...
def main(params):
    ...
    # save_dir = save_dir+"/bridge2algebra2006_simpleukt_qid_saved_model_42_0_0.1_512_64_2_4_0.5_0.5_0.5_50_256_64_4_4_1e-05_0_0_1_0.02_1_0"
    ...
    if model_name not in ["dimkt"]:
        test_loader, test_window_loader, test_question_loader, test_question_window_loader, test_dataset, test_window_dataset, test_question_dataset, test_question_window_dataset = init_test_datasets(data_config, model_name, batch_size)
    else:
