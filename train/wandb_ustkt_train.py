...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="ustkt")
    ...
    parser.add_argument('--gamma2', type=float, default=1.0,
                    help='init time_compress_coeff (per-head) via gamma2; used in hawkes time compression')


    parser.add_argument("--use_decoupling", type= int, default=0)                     
    parser.add_argument("--use_CL", type= int, default=0)

    parser.add_argument("--atten_type", type= str, default="w2_hawkes")
