...
def main(params):
    ...
    if model_name in ["saint","saint++", "sakt", "atdkt", "simplekt", "ustkt","bakt_time","folibikt"]:
    ...
    if model_name == "rkt":
        ...
        testauc, testacc, window_testauc, window_teustacc, validauc, validacc, best_epoch,temps = train_model.train_model(model, train_loader, valid_loader, num_epochs, opt, ckpt_path, None, None, save_model)
